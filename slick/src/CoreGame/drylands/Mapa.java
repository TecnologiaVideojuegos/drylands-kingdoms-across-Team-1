...
public class Mapa implements Serializable {
    ...
    public void renderTab() {
        ...
        mapa.render((int)((SCREENRESX-escalatab*(mapa.getWidth()*mapa.getTileWidth()))/2),(int)((SCREENRESY-escalatab*(mapa.getHeight()*mapa.getTileHeight()))/2), 0, 0, mapa.getWidth(), mapa.getHeight(), false);
