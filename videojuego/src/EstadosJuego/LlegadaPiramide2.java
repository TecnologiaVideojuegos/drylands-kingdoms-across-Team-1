...
public class LlegadaPiramide2 extends BasicGameState {
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        ...
        introimg=new Image("ficheros/LlegadaPiramide2.png");
        movimiento=true;
        msFinal=0;
    }
    ...
    public void update(GameContainer container, StateBasedGame game, int delta) {
        ...
        if(Keyboard.isKeyDown(Input.KEY_ESCAPE)||msFinal>=3000){
            game.enterState(77, new FadeOutTransition(Color.black), new FadeInTransition(Color.black));
