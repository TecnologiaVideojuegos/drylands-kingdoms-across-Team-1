...
public class LlegadaPiramide1 extends BasicGameState {
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        ...
        introimg=new Image("ficheros/LlegadaPiramide1.png");
        movimiento=true;
        msFinal=0;
    }
    ...
    public void update(GameContainer container, StateBasedGame game, int delta) {
        ...
        if(Keyboard.isKeyDown(Input.KEY_ESCAPE)||msFinal>=3000){
            game.enterState(76, new FadeOutTransition(Color.black), new FadeInTransition(Color.black));
